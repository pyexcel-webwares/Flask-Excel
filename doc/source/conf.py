# -*- coding: utf-8 -*-
#
# flask-excel documentation build configuration file, created by
...
texinfo_documents = [
  ('index', 'flask-excel', u'flask-excel Documentation',
   u'C.W.', 'flask-excel', 'One line description of project.',
   'Miscellaneous'),
]
